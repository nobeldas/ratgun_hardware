...
class GunTFMatrixPublisher(Node):
    ...
    def __init__(self):
        super().__init__('servo2_tf_matrix_publisher')

        self.declare_parameter('target_frame', 'base_link')
        self.declare_parameter('source_frame', 'servo2_link')
        self.declare_parameter('output_topic', '/servo2_transform_matrix')
    ...
    def publish_matrix(self):
        ...
        try:
            ...
            T[:3, :3] = R
            T[:3, 3] = [x, y, z]  #t[(row)start:stop, (column)start:stop]
